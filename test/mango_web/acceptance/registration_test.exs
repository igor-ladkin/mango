defmodule MangoWeb.Acceptance.RegistraionTest do
  use Mango.DataCase
  use Hound.Helpers
  ...
  test "registers an account with valid data" do
    ...
    find_within_element(form, :name, "registration[phone]") |> fill_field("42424242")
    find_within_element(form, :css, "#registration_residence_area option[value='Area 1']") |> click()
  ...
  test "it shows error messages with invalid data" do
    navigate_to("/register")
